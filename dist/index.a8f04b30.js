...
function getWeather() {
    navigator.geolocation.getCurrentPosition(async function(position) {
        try {
            await (0, _axiosDefault.default)("https://api.openweathermap.org/data/2.5/weather?&appid=401395c8bb11a6dde982bcf35f6812e4&units=metric&lat=" + position.coords.latitude + "&lon=" + position.coords.longitude)//`api.openweathermap.org/data/2.5/weather?lat=${position.coords.latitude}&lon=${position.coords.longitude}&appid=401395c8bb11a6dde982bcf35f6812e4`
            .then((response)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hSiTh","5AKj5"], "5AKj5", "parcelRequiredfd2")
